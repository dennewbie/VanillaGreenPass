...
int main (int argc, char * argv[]) {
    ...
    getVaccination(centroVaccinaleSocketFileDescriptor, (const void *) healthCardNumber, (size_t) sizeof(char) * strlen(healthCardNumber), newCentroVaccinaleReply);
...
//    int temp1 = 1, temp2;
//    write(centroVaccinaleSocketFileDescriptor, & temp1, sizeof(int));
//    fullRead(centroVaccinaleSocketFileDescriptor, &temp2, sizeof(int));
//    printf("\nvalue temp2: %d\n", temp2);
}
